...
from .views import (
    ...
    RecipeUpdateView, RecipeDeleteView, login_view, register_view, logout_view, home_view, news_view, gemini_generate_description
)
...
urlpatterns = [
    ...
    path("gemini/description/", gemini_generate_description, name="gemini_generate_description"),
