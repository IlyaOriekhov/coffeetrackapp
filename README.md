...
- [ ] Зробити адаптивний дизайн для mob i tab
- [ ] Профіль користувача з статистикою
- [ ] API (Django REST Framework)
- [ ] Оновити UI: Django + Tailwind CSS + Flowbite
- [ ] Улюблені рецепти та історія заварювань
- [ ] Експорт рецептів у PDF
- [ ] Рейтинги та коментарі до рецептів
- [ ] Телеграм-бот для швидкого додавання кави
- [ ] AI-рекомендації рецептів на основі наявної кави
- [ ] Підтримка української та англійської мов
- [ ] Deployment на хостинг (Railway/PythonAnywhere)
